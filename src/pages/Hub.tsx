...
const Hub: React.FC = () => {
  const { bookmarks, loading, handleDelete, handleBulkDelete, handleToggleFavorite } = useBookmarks();
  ...
  const handleEdit = (bookmark: Bookmark) => {
    // For now, we'll just open the URL since we don't have an edit modal in this context
