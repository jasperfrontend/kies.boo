...
const Hub: React.FC = () => {
  ...
  // Use the app layout hook with hub-specific options
  const {
    isDialogOpen,
    setIsDialogOpen,
    compactMode
  ...
  // Get expanded collections from URL parameters - auto-generated collections are expanded by default
  const expandedCollections = useMemo(() => {
    const expanded = searchParams.get('expanded');
    const expandedSet = expanded ? new Set(expanded.split(',').filter(Boolean)) : new Set<string>();
    
    // Add all auto-generated collections to the expanded set by default
  ...
  // Function to update expanded collections in URL - handle auto-generated collections specially
  const updateExpandedCollections = (collectionId: string, isExpanded: boolean) => {
    ...
    // Filter out auto-generated collections from URL params since they're expanded by default
