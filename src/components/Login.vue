        ...
        >
          <div class="text-center mb-4">
            <v-avatar size="56" class="mb-2" color="primary">
              <v-img src="/favicon.png" width="48" height="48" />
            </v-avatar>
          ...
          <v-card-text>
            ...
            <div class="mt-6 text-center text-medium-emphasis text-caption">
              <v-icon icon="mdi-lock" class="mr-1" size="18"/>
              <span>
                We use the providers above <span class="font-italic">solely</span> for authentication.<br>
                We <strong>cannot</strong> post or change anything on your profiles.<br>
                We just need your email, username and profile pic to authenticate you.
              </span>
            </div>
          </v-card-text>
        </v-card>
...
.shiny-login {
  /* Glassmorphism */
  background: rgba(var(--v-theme-surface-rgb), 0.85);
...
.shiny-login:hover {
  box-shadow: 0 10px 44px 0 rgba(0,0,0,0.25), 0 2px 5px rgba(0,0,0,0.12);
}
...
.provider-btn {
  ...
  letter-spacing: .01em;
  border-radius: 999px;
  transition: transform 0.16s cubic-bezier(.4,0,.2,1), box-shadow 0.2s;
